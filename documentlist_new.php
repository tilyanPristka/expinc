...
if ($_GET['bSubmitted']):
	...
	$sList		= "SELECT d.DocID, d.DocFullNo, d.DocClear, d.DocNotes, d.DocAdjusted, d.DocDate, d.DocPrinted, d.DocCode, d.DocCode2, d.DocNickName, a.TransID, a.AccNo, a.AccName, a.Description, a.Amount, la.Type FROM tilyan_".$_SESSION['TLY__MemberFolder']."_document d, tilyan_".$_SESSION['TLY__MemberFolder']."_account a LEFT JOIN tilyan_".$_SESSION['TLY__MemberFolder']."_lookup_account la ON a.AccNo = la.AccNo WHERE d.DocID  = a.DocID";
	if($bError!=1):
	...
	$sList		= "SELECT d.DocID, d.DocFullNo, d.DocDate, d.DocClear, d.DocNotes, d.DocAdjusted, d.DocPrinted, d.DocCode, d.DocCode2, d.DocNickName, a.TransID, a.AccNo, a.AccName, a.Description, a.Amount, la.Type FROM tilyan_".$_SESSION['TLY__MemberFolder']."_document d, tilyan_".$_SESSION['TLY__MemberFolder']."_account a LEFT JOIN tilyan_".$_SESSION['TLY__MemberFolder']."_lookup_account la ON a.AccNo = la.AccNo WHERE d.DocID  = a.DocID";
    ...
    <body>
        ...
        <div class="other" style="margin-bottom:6px;">
			...
			<table width="100%" cellpadding="2" cellspacing="3" border="0" align="center" class="OSStyle">
				...
				<tr align="right">
					<td style="height:22px; padding-right:14px;" nowrap="nowrap"><input type="button" name="bnReport" id="bnReport" value="Generate Report from Current List" onclick="javascript:window.open('<?php echo $sReport?>');" />&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" name="bnFilter" id="bnFilter" class="example8" value="Filter Option" />&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" name="bnClear" id="bnClear" value="Clear Filter" onClick="javascript:document.location.href = '<?php echo $_SERVER['PHP_SELF']."?"?>';"></td>
				</tr>
			</table>
			</form>
            </div>
			...
			$sPaging	.= " ORDER BY d.DocYear, d.DocMonth, d.DocNo, a.TransID";
...
//			echo "Page : ";
			echo "<form name=\"frmPaging\" id=\"frmPaging\" method=\"get\" action=\"documentlist_new.php\">";
			if($_GET["bSubmitted"]):
...
//					print " <strong>[$k]</strong> ";
			...
			$sList		.= " ORDER BY d.DocYear, d.DocMonth, d.DocNo, a.TransID LIMIT $Pg, $Limit";
