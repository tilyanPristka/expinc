...
header("Content-disposition: attachment; filename=laporan_kegiatan.xls"); // filename terserah anda
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
       ...
       <div class="other" style="margin-bottom:6px;">
        	<center>
            <table width="1500" cellpadding="2" cellspacing="3" border="0">
                <tr>
                ...
                <tr style="height:25px; font-size:13px; font-weight:bold; background-color:#FF9933;" onclick="javascript:animatedcollapse.toggle('cashbank');" onmouseover="document.body.style.cursor='pointer';"  onmouseout="document.body.style.cursor='default';">
                    <td width="150" style="padding-left:6px;">Cash/Bank</td>
                    <td width="225" style="padding-right:6px; text-align:right;"><?php echo ConvertMoneyFormatIndo2($iTotalCashBank);?></td>
                    <td width="225" style="padding-left:6px;"></td>
                    <td width="225" style="padding-left:6px;"></td>
                    <td width="225" style="padding-left:6px;"></td>
                </tr>
                <?php
                ...
                ?>
                <tr>
                    <td class="detail" align="center"><?php echo ViewDateTimeFormat($oCashBankList->DocDate,7)?></td>
                    <!-- <td class="detail"><?php echo $oCashBankList->DocFullNo?></td> //-->
                    <td class="detail"><?php echo $sDocFullNo?></td>
                    <td class="detail"><?php echo $oCashBankList->AccNo?></td>
                    <td class="detail"><?php echo $oCashBankList->Description?></td>
                    <td align="right" class="detail"><?php if($oCashBankList->DocInOut=='O'){ echo "-"; }?><?php echo ConvertMoneyFormatIndo2($oCashBankList->Amount)?></td>
                </tr>
                <?php
                	}
                ?>
				...
				<tr style="height:25px; font-size:13px; font-weight:bold; background-color:#EEEEEE;" onclick="javascript:animatedcollapse.toggle('revenue');" onmouseover="document.body.style.cursor='pointer';"  onmouseout="document.body.style.cursor='default';">
					<td style="padding-left:6px;">Revenue</td>
					<td style="padding-left:6px;"></td>
					<td style="padding-right:6px; text-align:right;"><?php echo ConvertMoneyFormatIndo2($iTotalRevenue);?></td>
					<td style="padding-left:6px;"></td>
					<td style="padding-left:6px;"></td>
                </tr>
                <?php
                ...
                ?>
                <tr>
                    <td class="detail" align="center"><?php echo ViewDateTimeFormat($oRevenueList->DocDate,7)?></td>
                    <!-- <td class="detail"><?php echo $oRevenueList->DocFullNo?></td> //-->
                    <td class="detail"><?php echo $sDocFullNo?></td>
                    <td class="detail"><?php echo $oRevenueList->AccNo?></td>
                    <td class="detail"><?php echo $oRevenueList->Description?></td>
                    <td align="right" class="detail"><?php echo ConvertMoneyFormatIndo2($oRevenueList->Amount)?></td>
                </tr>
                <?php
                    }
                ?>
				...
				<tr style="height:25px; font-size:13px; font-weight:bold; background-color:#FFFF66;" onclick="javascript:animatedcollapse.toggle('cgs');" onmouseover="document.body.style.cursor='pointer';"  onmouseout="document.body.style.cursor='default';">
					<td style="padding-left:6px;">Cost of Good Sold</td>
					<td style="padding-left:6px;"></td>
					<td style="padding-left:6px;"></td>
					<td style="padding-right:6px; text-align:right;"><?php echo ConvertMoneyFormatIndo2(0-$iTotalCGS);?></td>
					<td style="padding-left:6px;"></td>
                </tr>
                <?php
				if($out==1):
				...
				?>
                <tr>
                    <td class="detail" align="center"><?php echo ViewDateTimeFormat($oCGSList->DocDate,7)?></td>
                    <!-- <td class="detail"><?php echo $oCGSList->DocFullNo?></td> //-->
                    <td class="detail"><?php echo $sDocFullNo?></td>
                    <td class="detail"><?php echo $oCGSList->AccNo?></td>
                    <td class="detail"><?php echo $oCGSList->Description?></td>
                    <td align="right" class="detail"><?php echo ConvertMoneyFormatIndo2(0-$oCGSList->Amount)?></td>
                </tr>
                <?php
                    }
                ?>
				...
				<tr style="height:25px; font-size:13px; font-weight:bold; background-color:#EEEEEE" onclick="javascript:animatedcollapse.toggle('expenses');" onmouseover="document.body.style.cursor='pointer';"  onmouseout="document.body.style.cursor='default';">
					<td style="padding-left:6px;">Expenses</td>
					<td style="padding-left:6px;"></td>
					<td style="padding-left:6px;"></td>
					<td style="padding-left:6px;"></td>
					<td style="padding-right:6px; text-align:right;"><?php echo ConvertMoneyFormatIndo2(0-$iTotalExpenses);?></td>
                </tr>
                <?php
				if($out==1):
                ...
                ?>
                <tr>
                    <td class="detail" align="center"><?php echo ViewDateTimeFormat($oExpensesList->DocDate,7)?></td>
                    <!-- <td class="detail"><?php echo $oExpensesList->DocFullNo?></td> //-->
                    <td class="detail"><?php echo $sDocFullNo?></td>
                    <td class="detail"><?php echo $oExpensesList->AccNo?></td>
                    <td class="detail"><?php echo $oExpensesList->Description?></td>
                    <td align="right" class="detail"><?php echo ConvertMoneyFormatIndo2(0-$oExpensesList->Amount)?></td>
                </tr>
                <?php
                    }
                ?>
				...
				<tr style="height:25px; font-size:13px; font-weight:bold; background-color:#FFFF66;" onclick="javascript:animatedcollapse.toggle('otherincome');" onmouseover="document.body.style.cursor='pointer';"  onmouseout="document.body.style.cursor='default';">
					<td style="padding-left:6px;">Other Income</td>
					<td style="padding-left:6px;"></td>
					<td style="padding-right:6px; text-align:right;"><?php echo ConvertMoneyFormatIndo2($iTotalOtherIncome);?></td>
					<td style="padding-left:6px;"></td>
					<td style="padding-left:6px;"></td>
                </tr>
                <?php
                ...
                ?>
                <tr>
                    <td class="detail" align="center"><?php echo ViewDateTimeFormat($oOtherIncomeList->DocDate,7)?></td>
                    <!-- <td class="detail"><?php echo $oOtherIncomeList->DocFullNo?></td> //-->
                    <td class="detail"><?php echo $sDocFullNo?></td>
                    <td class="detail"><?php echo $oOtherIncomeList->AccNo?></td>
                    <td class="detail"><?php echo $oOtherIncomeList->Description?></td>
                    <td align="right" class="detail"><?php echo ConvertMoneyFormatIndo2($oOtherIncomeList->Amount)?></td>
                </tr>
                <?php
                    }
                ?>
				...
				<tr style="height:25px; font-size:13px; font-weight:bold; background-color:#EEEEEE" onclick="javascript:animatedcollapse.toggle('otherexpenses');" onmouseover="document.body.style.cursor='pointer';"  onmouseout="document.body.style.cursor='default';">
					<td style="padding-left:6px;">Other Expenses</td>
					<td style="padding-left:6px;"></td>
					<td style="padding-left:6px;"></td>
					<td style="padding-left:6px;"></td>
					<td style="padding-right:6px; text-align:right;"><?php echo ConvertMoneyFormatIndo2(0-$iTotalOtherExpenses);?></td>
                </tr>
                <?php
				if($in==1):
                ...
                ?>
                <tr>
                    <td class="detail" align="center"><?php echo ViewDateTimeFormat($oOtherExpensesList->DocDate,7)?></td>
                    <!-- <td class="detail"><?php echo $oOtherExpensesList->DocFullNo?></td> //-->
                    <td class="detail"><?php echo $sDocFullNo?></td>
                    <td class="detail"><?php echo $oOtherExpensesList->AccNo?></td>
                    <td class="detail"><?php echo $oOtherExpensesList->Description?></td>
                    <td align="right" class="detail"><?php echo ConvertMoneyFormatIndo2(0-$oOtherExpensesList->Amount)?></td>
                </tr>
                <?php
                    }
                ?>
				...
				<tr style="height:25px; font-size:13px; font-weight:bold;">
					<td style="padding-left:6px;"></td>
					<td style="padding-left:6px;"></td>
					<td style="padding-right:6px; text-align:right; border-top:2px solid #990000;"><?php echo ConvertMoneyFormatIndo2($iTotalRevenue+$iTotalOtherIncome);?></td>
					<td style="padding-right:6px; text-align:right; border-top:2px solid #990000;"><?php echo ConvertMoneyFormatIndo2(0-$iTotalCGS);?></td>
					<td style="padding-right:6px; text-align:right; border-top:2px solid #990000;"><?php echo ConvertMoneyFormatIndo2(0-($iTotalExpenses+$iTotalOtherExpenses));?></td>
                </tr>
            </table>
			</center>
		</div>
