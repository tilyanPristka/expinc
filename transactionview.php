...
$sSQLGetDocInfo		= mysql_query("SELECT DocDate, DocFullNo, DocYear, DocMonth, DocNotes, DocClear, RefDocID FROM tilyan_".$_SESSION['TLY__MemberFolder']."_document WHERE DocID = '".$iDocID."' LIMIT 0,1") or die(mysql_errno()." : ".mysql_error());;
...
if ($_POST['bSubmitted']):
	...
	/* UPDATE */
	mysql_query("UPDATE tilyan_".$_SESSION['TLY__MemberFolder']."_document SET DocNotes = '".$sDocNotes."', DocClear = ".$iDocClear." WHERE DocID = ".$iDocID."") or die(mysql_errno()." : ".mysql_error());
        ...
        <div class="other" style="margin-bottom:6px;">
			...
			<table width="95%" cellpadding="2" cellspacing="3" border="0" align="center" class="OSStyle">
				...
				<tr>
					...
					<td align="right" style="border-bottom: 1px solid #990000; padding:5px;"><?php echo ConvertMoneyFormatIndo2($iAmount[$iRecLoop])?></td>
				</tr>
                <?php
				}
				?>
				...
				<tr>
					...
					<td colspan="3" align="left" style="padding:5px; font-size:12px;"><?php echo nl2br($sDocNotes); ?></td>
				</tr>
				<tr>
					<td align="right" valign="top" style="padding:5px; font-size:12px;"><strong>Set To Print:</strong></td>
					<td colspan="3" align="left" style="padding:5px; font-size:12px;"><?php if($iDocClear==1) { ?><span style="font-weight:bold; color:#006633;">This Document is Ready To Print</span><?php } else { ?><span style="font-weight:bold; color:#990000;">This Document has not been Set Ready To Print</span><?php } ?></td>
				</tr>
				<tr>
					<td colspan="4">&nbsp;</td>
				</tr>
				<tr>
					<td></td>
					<td colspan="2"><input type="button" name="bnExit" id="bnExit" value="Close" onClick="javascript:document.location.href='documentlist.php';"></td>
                    <td></td>
				</tr>
			</table>
			</form>
