    ...
    <body>
        <div class="other" style="margin-bottom:6px;">
			...
			<table width="100%" cellpadding="2" cellspacing="3" border="0">
				<tr>
					<td align="center" style="height:30px; background-color:#990000; color:#F4F4F4; font-size:12px; font-weight:bold;">This is For Viewing Purpose Only&nbsp;&nbsp;&nbsp;&nbsp;<button onclick="javascript:window.close();">Close</button>&nbsp;&nbsp;<button onclick="javascript:document.location.href='transactionprintcount.php?doc=<?php echo base64_encode($iDocID)?>'">Print</button>&nbsp;&nbsp;</td>
				</tr>
			</table>
            <table width="95%" cellpadding="2" cellspacing="3" border="0">
                <tr>
                    ...
                    <td valign="top" align="right" rowspan="3">
						<img src="images/main_logo_small.png" />
					</td>
                </tr>
                <tr>
                    <td align="left"><div style="font-size:18px; font-weight:bold;"><?php echo $sInOutText?></div></td>
                </tr>
                <tr>
			...
			<table width="95%" cellpadding="2" cellspacing="3" border="0" align="center" class="OSStyle">
				<tr>
					...
					<td colspan="3"><div style="font-size:14px; font-weight:bold;"><?php echo $sDocFullNo ?><?php if(!empty($sRefDocFullNo)){ echo " (Ref. Doc #: ".$sRefDocFullNo.")"; } ?></div></td>
				</tr>
