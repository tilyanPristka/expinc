...
$sSQLCashBankList = "SELECT d.DocDate, d.DocFullNo, d.DocInOut, a.AccNo, a.AccName, a.Description, a.Amount FROM tilyan_".$_SESSION['TLY__MemberFolder']."_document d, tilyan_".$_SESSION['TLY__MemberFolder']."_account a LEFT JOIN tilyan_".$_SESSION['TLY__MemberFolder']."_lookup_account la ON a.AccNo = la.AccNo WHERE d.DocID = a.DocID";
if(!empty($db) && !empty($db)):
...
$sSQLRevenueList = "SELECT d.DocDate, d.DocFullNo, a.AccNo, a.AccName, a.Description, a.Amount FROM tilyan_".$_SESSION['TLY__MemberFolder']."_document d, tilyan_".$_SESSION['TLY__MemberFolder']."_account a LEFT JOIN tilyan_".$_SESSION['TLY__MemberFolder']."_lookup_account la ON a.AccNo = la.AccNo WHERE d.DocID = a.DocID AND d.DocInOut = 'I' AND la.Type = 'Revenue'";
if(!empty($db) && !empty($db)):
...
$sSQLCGSList = "SELECT d.DocDate, d.DocFullNo, a.AccNo, a.AccName, a.Description, a.Amount FROM tilyan_".$_SESSION['TLY__MemberFolder']."_document d, tilyan_".$_SESSION['TLY__MemberFolder']."_account a LEFT JOIN tilyan_".$_SESSION['TLY__MemberFolder']."_lookup_account la ON a.AccNo = la.AccNo WHERE d.DocID = a.DocID AND d.DocInOut = 'O' AND la.Type = 'Cost of Goods Sold'";
if(!empty($db) && !empty($db)):
...
$sSQLExpensesList = "SELECT d.DocDate, d.DocFullNo, a.AccNo, a.AccName, a.Description, a.Amount FROM tilyan_".$_SESSION['TLY__MemberFolder']."_document d, tilyan_".$_SESSION['TLY__MemberFolder']."_account a LEFT JOIN tilyan_".$_SESSION['TLY__MemberFolder']."_lookup_account la ON a.AccNo = la.AccNo WHERE d.DocID = a.DocID AND d.DocInOut = 'O' AND la.Type = 'Expense'";
if(!empty($db) && !empty($db)):
...
$sSQLOtherIncomeList = "SELECT d.DocDate, d.DocFullNo, a.AccNo, a.AccName, a.Description, a.Amount FROM tilyan_".$_SESSION['TLY__MemberFolder']."_document d, tilyan_".$_SESSION['TLY__MemberFolder']."_account a LEFT JOIN tilyan_".$_SESSION['TLY__MemberFolder']."_lookup_account la ON a.AccNo = la.AccNo WHERE d.DocID = a.DocID AND d.DocInOut = 'I' AND la.Type = 'Other Income'";
if(!empty($db) && !empty($db)):
...
$sSQLOtherExpensesList = "SELECT d.DocDate, d.DocFullNo, a.AccNo, a.AccName, a.Description, a.Amount FROM tilyan_".$_SESSION['TLY__MemberFolder']."_document d, tilyan_".$_SESSION['TLY__MemberFolder']."_account a LEFT JOIN tilyan_".$_SESSION['TLY__MemberFolder']."_lookup_account la ON a.AccNo = la.AccNo WHERE d.DocID = a.DocID AND d.DocInOut = 'O' AND la.Type = 'Other Expense'";
if(!empty($db) && !empty($db)):
...
header("Content-disposition: attachment; filename=trial_excel.xls"); // filename terserah anda
