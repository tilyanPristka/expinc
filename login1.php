...
<script src="Scripts1/swfobject_modified.js" type="text/javascript"></script>
<script src="SpryAssets1/SpryMenuBar.js" type="text/javascript"></script>
<link href="SpryAssets1/SpryMenuBarHorizontal.css" rel="stylesheet" type="text/css" />
</head>
  ...
  <!-- end div#header -->
   <div id="header_gallery">
        ...
        <li><a class="MenuBarItemSubmenu" href="#">
          ...
          <li><a href="/tp/index.php"><h1>client area</h1></a></li>
   	  </ul></div>
...
<center>
			...
			<table width="250" cellpadding="0" cellspacing="0" border="0" align="center">
			  <?php
				...
				?>
			  <tr valign="top">
					<td colspan="3" style="padding-left:5px; color:#990000; font-size:12; font-weight:bold;" align="center">
					  <p>[Authentication failed. Please try again.]</p>				    </td>
					<td width="10"></td>
				</tr>
				<?php
				}
				?>
				<tr valign="top">
					<td width="87" align="right" valign="middle"  style="font-size:11px"><strong>Username </strong></td>
					<td width="5" align="center" valign="middle" style="font-size:11px">:</td>
					<td width="100" align="left" style="font-size:11px">
					<input name="username" type="text" class="form" id="username" size="30"  style=" height:200px border: 1px solid #000000;">
					</td>
					<td width="10"></td>
				</tr>
				
				<tr valign="top">
				  <td valign="middle" align="right" style="font-size:11px">&nbsp;</td>
				  <td align="center" valign="middle"  style="font-size:11px">&nbsp;</td>
				  <td style="padding-left:0px; font-size:11px" align="left">&nbsp;</td>
				  <td></td>
			    </tr>
				<tr valign="top">
					<td valign="middle" align="right" style="font-size:11px"><strong>Password</strong></td>
					<td align="center" valign="middle"  style="font-size:11px">:</td>
					<td style="padding-left:0px; font-size:11px" align="left">
						<input name="password" type="password" class="form" id="password" size="30"><br>
					</td>
					<td width="10"></td>
				</tr>
				<tr valign="top">
			    ...
			    <td align="right" ><br><input type="submit" name="bnSubmit" id="bnSubmit" value="Login" style="width:100px; height:100px border: 1px solid #000000;"></td>
					<td width="10"></td>
				</tr>
				<tr valign="top">
					<td></td>
