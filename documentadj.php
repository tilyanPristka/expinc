...
if(!empty($iRefDocID)):
	...
	if($oGetDocFullNo = mysql_fetch_object($sSQLGetDocFullNo)):
		$sDocFullNo		= $oGetDocFullNo->DocFullNo;
	endif;
endif;
...
if ($_POST['bSubmitted']):
	...
	$sDocFullNo = strtoupper($sFolder).".".$sMandatory.".".$sType.".".$sInOut.".".strtoupper($sNickName).".".$sCode1."";
	if($sCode2!=""):
	...
	mysql_query("INSERT INTO tilyan_".$sFolder."_document (RefDocID,DocRealDate,DocDate,DocFullNo,DocFolder,DocADJ,DocType,DocInOut,DocNickName,DocCode,DocCode2,DocCode3,DocYear,DocMonth) VALUES (".$iRefDocID.",'".$dtDocRealDate."','".$sDocDate."','".$sDocFullNo."','".$sFolder."','".$sMandatory."','".$sType."','".$sInOut."','".$sNickName."','".$sCode1."','".$sCode2."','".$sCode3."','".$PilihTahun."','".$PilihBulan."')") or die(mysql_errno()." : ".mysql_error());
	mysql_query("UPDATE tilyan_".$sFolder."_document SET DocAdjusted = 1 WHERE DocID = ".$iRefDocID."") or die(mysql_errno()." : ".mysql_error());
	...
	if($sType=="O"):
		echo "<meta http-equiv=\"refresh\" content=\"0;URL=transactionaddother.php?ref=".$iRefDocID."&id=".$iFwdDocID."&rdate=".$sFwdDocRealDate."&date=".$sFwdDocDate."&doc=".$sFwdDocFullNo."&y=".$iFwdTahun."&m=".$iFwdBulan."\">";
	else:
		echo "<meta http-equiv=\"refresh\" content=\"0;URL=transactionadd.php?ref=".$iRefDocID."&id=".$iFwdDocID."&rdate=".$sFwdDocRealDate."&date=".$sFwdDocDate."&doc=".$sFwdDocFullNo."&y=".$iFwdTahun."&m=".$iFwdBulan."\">";
	endif;	
	exit();
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div class="other" style="margin-bottom:6px;">
            ...
            <p>&nbsp;</p>
            <p><center>
            <form name="ArticleFrm" id="ArticleFrm" action="<?php echo $_SERVER['PHP_SELF']."?doc=".$iRefDocID.""?>" method="post">
			...
			<table width="95%" cellpadding="2" cellspacing="3" border="0" align="center" class="OSStyle">
				...
				<?php	} ?>
				<tr>
					<td style="width: 150px; height:25px;" class="FormTD"><span style="font-size:12px; font-weight:bold;">Ref. Doc. #:</span></td>
					<td><span style="font-size:12px; font-weight:bold;"><?php echo $sDocFullNo; ?></span></td>
				</tr>
				<tr>
