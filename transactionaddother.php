        ...
        <div class="other" style="margin-bottom:6px;">
			...
			<table width="95%" cellpadding="2" cellspacing="3" border="0" align="center" class="OSStyle">
                ...
                <tr>
					...
					<td colspan="4" style="font-size:12px; font-weight:bold;"><?php echo $sRefDocFullNo; ?></td>
				</tr>
                <?php
				endif;
				?>
				<tr>
					...
					<td colspan="3"> <font color="#990000"><strong> *) TIME and XXXX will be filled automatically when you're done with this document.</strong></font></td>
				</tr>
				<tr>
				...
				?>
				<tr>
					<td style="border-bottom: solid 1px #990000; padding:6px 0 6px 0; background-color:#990000; font-weight:bold; font-size:12px; text-align:center; color:#FFF;" colspan="5"><?php echo $sAlertDifference; ?></td>
				</tr>
                <?php
					endif;
				?>
