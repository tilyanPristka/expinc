...
$RootMenu->AddMenuItem(17, $ReportLanguage->Phrase("DetailSummaryReportMenuItemPrefix") . $ReportLanguage->MenuPhrase("17", "MenuText") . $ReportLanguage->Phrase("DetailSummaryReportMenuItemSuffix"), "tp_rep_Dimension_1smry.php", -1, "", "", TRUE);
$RootMenu->AddMenuItem(16, $ReportLanguage->Phrase("DetailSummaryReportMenuItemPrefix") . $ReportLanguage->MenuPhrase("16", "MenuText") . $ReportLanguage->Phrase("DetailSummaryReportMenuItemSuffix"), "tp_rep_Chart_of_Accountsmry.php", -1, "", "", TRUE);
$RootMenu->AddMenuItem(18, $ReportLanguage->Phrase("SimpleReportMenuItemPrefix") . $ReportLanguage->MenuPhrase("18", "MenuText") . $ReportLanguage->Phrase("SimpleReportMenuItemSuffix"), "tp_rep_Transactionrpt.php", -1, "", "", TRUE);
$RootMenu->Render();
?>
</div>
<!-- End Main Menu -->
