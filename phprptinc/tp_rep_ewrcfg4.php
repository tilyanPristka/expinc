...
define("EWRPT_CONN_USER", 'tpocoin_tlyuser', TRUE);
define("EWRPT_CONN_PASS", 'tlypass', TRUE);
define("EWRPT_CONN_DB", 'tpocoin_tilyan', TRUE);
...
define("EWRPT_RANDOM_KEY", 'jQEe9k0vhixTdYLC', TRUE); // Random key for encryption
...
// User admin
define("EWRPT_LOGIN_SELECT_SQL", "SELECT * FROM `tilyan_membersperson`", TRUE);
...
define("EWRPT_SMTP_SERVER", "mail.tpo.co.in", TRUE); // SMTP server
define("EWRPT_SMTP_SERVER_PORT", 25, TRUE); // SMTP server port
define("EWRPT_SMTP_SERVER_USERNAME", "report@tpo.co.in", TRUE); // SMTP server user name
define("EWRPT_SMTP_SERVER_PASSWORD", "1234567890asdfg", TRUE); // SMTP server password
...
// Validate option
define("EWRPT_CLIENT_VALIDATE", TRUE, TRUE);
define("EWRPT_SERVER_VALIDATE", TRUE, TRUE);
