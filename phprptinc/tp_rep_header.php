...
<html>
<head>
	<title>tilyanPristka - Activity Reporting Support For Accounting Environment</title>
<?php if (@$gsExport == "") { ?>
...
<div class="ewLayout">
	...
	<div class="ewHeaderRow"><img src="phprptimages/tp_logo_s.jpg" alt="" border="0" /></div>
	<!-- header (end) -->
	<!-- content (begin) -->
	<!-- navigation -->
