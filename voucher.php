        ...
        <div class="other" style="float:left; margin-bottom:6px;">
			...
			<?php
				...
				foreach(glob($dir) as $file) {
					...
					echo "<div class=\"files\" style=\"float:$sFloat;\"><img src=\"images/icon_voucher.png\" align=\"absmiddle\" style=\"padding-right: 6px;\">filename: <a href=\"$file\" class=\"normallink\">$sTrueFilename</a></div>";
					$iFiles = $iFiles+1;
					if($iFiles==2):
						echo "<br />";
					endif;
