...
if ($_POST['bSubmitted']) {
	...
	if (!$bError) {
		/* INSERT */
		mysql_query("INSERT INTO tilyan_".$sFolder."_lookup_code3 (CodeName, CodeDesc, ContractNo, ContractValue, StartDate, EndDate, Status) VALUES ('".$CodeName."', '".$CodeDesc."', '".$ContractNo."', '".$ContractValue."', '".$StartDate."', '".$EndDate."', '".$Status."')") or die(mysql_errno()." : ".mysql_error());
...
<body>
	<div id="main">
        ...
        <div class="basic" style="float:left; margin-left: 2em;" id="mylist">
            ...
            <a>Client's Look Up Code III Add</a>
