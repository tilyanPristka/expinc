...
$sql = ' CREATE TABLE `tilyan_'.$sFolderName.'_lookup_code3` ( `ID` bigint( 100 ) NOT NULL AUTO_INCREMENT PRIMARY KEY,'
...
mysql_query("INSERT INTO tilyan_memberstable (CoID, TableName) VALUES ('".$iCoID."', 'tilyan_".$sFolderName."_lookup_code3')") or die(mysql_errno()." : ".mysql_error());
